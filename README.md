...
1. На GitHub проверьте версию в `public/manifest.json`: для этого выпуска нужна **1.5.0**. Пока изменения ждут слияния, выберите ветку `codex/page-target`, скачайте её через **Code → Download ZIP** и распакуйте архив.
