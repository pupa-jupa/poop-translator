...
Для всей страницы выберите отдельную цель и подтвердите действие кнопкой **Начать** на странице. Если на странице встретится язык с ещё не загруженной парой, появится **Подготовить и перевести**. После подтверждения работа продолжается без popup. Текст уже на выбранном языке остаётся оригинальным.
