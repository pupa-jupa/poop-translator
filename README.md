...
1. На GitHub проверьте версию в `public/manifest.json`: для этого выпуска нужна **1.4.0**. Пока изменения ждут слияния, выберите ветку `codex/review-cards`, скачайте её через **Code → Download ZIP** и распакуйте архив.
